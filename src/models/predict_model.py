...
#     output_file = (
#         f's3://nyc-duration-prediction-alexey/taxi_type=
#         {taxi_type}/year={year:04d}/month={month:02d}/{run_id}.parquet'
#     )
#
...
#
#     ride_duration_prediction(taxi_type=taxi_type, run_id=run_id, run_date=datetime(year=year, month=month, day=1))
#
#
